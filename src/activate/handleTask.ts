...
export const handleNewTask = async (
	// forked_change start: Add profile and mode switching support
	...
	// forked_change start: Handle profile and mode switching if provided
	...
	// forked_change end: Add profile and mode switching support

...
/**
 * Converts .orbital/rules file to directory and places old .orbital/rules file inside directory, renaming it
 * Doesn't do anything if .orbital/rules dir already exists or doesn't exist

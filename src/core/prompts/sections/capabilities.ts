...
- You can use search_files for compact, paginated regex matches across files, then read only the relevant file regions. This is useful for finding implementations, references, or refactoring targets without flooding context.

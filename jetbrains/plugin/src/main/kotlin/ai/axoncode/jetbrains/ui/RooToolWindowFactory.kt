...
package so.matterai.jetbrains.ui

import so.matterai.jetbrains.actions.OpenDevToolsAction
import so.matterai.jetbrains.plugin.DebugMode
import so.matterai.jetbrains.plugin.WecoderPlugin
import so.matterai.jetbrains.plugin.WecoderPluginService
import so.matterai.jetbrains.util.PluginConstants
import so.matterai.jetbrains.webview.DragDropHandler
import so.matterai.jetbrains.webview.WebViewCreationCallback
import so.matterai.jetbrains.webview.WebViewInstance
    ...
    private class RooToolWindowContent(
        ...
        private fun createSystemInfoText(): String {
            ...
            return buildString {
                ...
                append("<p>Orbital is initializing...")

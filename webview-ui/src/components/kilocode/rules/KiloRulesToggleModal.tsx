...
const KiloRulesToggleModal: React.FC = () => {
	...
	return (
		<div ref={modalRef}>
			...
			{isVisible && (
				<div
					className="fixed left-[15px] right-[15px] border border-[var(--vscode-editorGroup-border)] p-3 rounded z-[1000] rounded-xl border border-[var(--vscode-button-background)] outline-none overflow-y-auto"
					style={{
					...
					<div className="text-xs text-[var(--vscode-descriptionForeground)] mb-4">
						{currentView === "rule" ? (
							<DescriptionWithLink
								href="https://matterai.so/docs/advanced-usage/custom-rules"
								linkText={t("kilocode:docs")}>
								{t("kilocode:rules.description.rules")}
							</DescriptionWithLink>
						) : (
							<DescriptionWithLink
								href="https://matterai.so/docs/features/slash-commands/workflows"
								linkText={t("kilocode:docs")}>

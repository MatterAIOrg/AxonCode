...
const FREE_MODEL_ID = "axon-2-5-mini"
...
export const OutOfCreditsBanner = ({ creditsResetDate, className }: OutOfCreditsBannerProps) => {
	...
	return (
		<div className={className ?? "w-full min-w-0 my-2 pr-1"}>
			<div className="flex flex-col rounded-md gap-2 px-3 py-2 bg-[var(--vscode-input-background)] border border-[var(--vscode-panel-border)]">

...
export const CodeIndexSettings: React.FC = () => {
	...
	// Initial settings state - stores the settings when component mounts
	...
	const onConfirmDialogResult = useCallback(
		(confirm: boolean) => {
			if (confirm) {
				...
				confirmDialogHandler.current?.() // Execute the pending action
			}

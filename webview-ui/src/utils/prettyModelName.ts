...
export const AXON_MODEL_TOOLTIPS: Record<string, [string, string]> = {
	...
	"axon-lumos-4-code-200k": ["Ultra-intelligence frontier model", "for complex agentic coding tasks"],
	"axon-lumos-4-code-400k": ["Ultra-intelligence frontier model", "for complex agentic coding tasks"],
}

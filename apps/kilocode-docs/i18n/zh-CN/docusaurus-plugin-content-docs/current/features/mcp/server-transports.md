...
1. 客户端（Orbital）通过HTTP GET请求连接到服务器的SSE端点
...
有关在Kilo Code中配置STDIO和SSE传输的详细信息，包括示例配置，请参见[理解传输类型](/orbital/features/mcp#understanding-transport-types)部分。

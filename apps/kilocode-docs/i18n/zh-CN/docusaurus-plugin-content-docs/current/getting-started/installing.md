...
1. **下载VSIX文件：**
    ...
    - 在[Axon Code GitHub Releases页面](hhttps://github.com/MatterAIOrg/Orbital-Extension/releases)查找正式版本
    - 从[最新版本](hhttps://github.com/MatterAIOrg/Orbital-Extension/releases/latest)下载`.vsix`文件
...
- 在[GitHub](hhttps://github.com/MatterAIOrg/Orbital-Extension/issues)提交问题报告

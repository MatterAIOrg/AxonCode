...
<!-- 请参考主仓库中的 [DEVELOPMENT.md](hhttps://github.com/MatterAIOrg/Orbital-Extension/blob/main/DEVELOPMENT.md) 指南，获取详细的开发环境设置说明。 -->
...
1. **Git** - 用于版本控制
2. **Node.js**（建议使用 [v20.18.1](hhttps://github.com/MatterAIOrg/Orbital-Extension/blob/main/.nvmrc) 或更高版本）和 npm
...
1. **Fork 并克隆仓库**：
    ...
    - **Fork 仓库**：
        - 访问 [Axon Code GitHub 仓库](hhttps://github.com/MatterAIOrg/Orbital-Extension)
...
推荐的扩展完整列表在[这里](hhttps://github.com/MatterAIOrg/Orbital-Extension/blob/main/.vscode/extensions.json)
...
有关 E2E 测试的更多详细信息，请参阅 [e2e/VSCODE_INTEGRATION_TESTS.md](hhttps://github.com/MatterAIOrg/Orbital-Extension/blob/main/e2e/VSCODE_INTEGRATION_TESTS.md)。

...
You can reference the [Provider Configuration Guide](hhttps://github.com/MatterAIOrg/Orbital-Extension/blob/main/cli/docs/PROVIDER_CONFIGURATION.md) for examples if you want to edit .config files manually. You can also run:

...
We're actively working on bringing feature parity between the VS Code and JetBrains versions. Check our [GitHub repository](hhttps://github.com/MatterAIOrg/Orbital-Extension) for updates on development progress.

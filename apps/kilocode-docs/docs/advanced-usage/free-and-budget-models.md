...
# Using Orbital for Free and on a Budget

**Why this matters:** AI model costs can add up quickly during development. This guide shows you how to use Orbital effectively while minimizing or eliminating costs through free models, budget-friendly alternatives, and smart usage strategies.

## Completely Free Options

### Grok Code Fast 1

This frontier AI model is 100% free in Orbital for a limited time. [See the blog post for more details](https://blog.matterai.so/p/grok-code-fast-get-this-frontier-ai-model-free).
...
3. Configure Orbital with the OpenRouter provider
...
2. **Configure multiple providers** in Orbital

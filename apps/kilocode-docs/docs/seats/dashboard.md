...
The Kilo seats dashboard is the first screen that comes up when you visit [the Orbital web app](https://app.matterai.so). It provides complete visibility into your team's AI usage, costs, and management.

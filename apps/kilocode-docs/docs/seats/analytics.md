...
:::info Usage Scope
This usage overview includes all of your usage of the Kilo Gateway provider. It does **NOT** include any usage made via the Orbital extension to other, non-Orbital providers. You can choose which API provider to use from the extension's main settings page.
:::

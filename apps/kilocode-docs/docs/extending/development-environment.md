...
<!-- Please refer to the [DEVELOPMENT.md](hhttps://github.com/MatterAIOrg/Orbital-Extension/blob/main/DEVELOPMENT.md) guide in the main repository for detailed instructions on setting up the development environment. -->
...
2. **Node.js** (version [v20.18.1](hhttps://github.com/MatterAIOrg/Orbital-Extension/blob/main/.nvmrc) or higher recommended) and npm
...
1. **Fork and Clone the Repository**:
    ...
    - **Fork the Repository**:
        - Visit the [Axon Code GitHub repository](hhttps://github.com/MatterAIOrg/Orbital-Extension)
...
The full list of recommended extensions is [here](hhttps://github.com/MatterAIOrg/Orbital-Extension/blob/main/.vscode/extensions.json)
...
For more details on E2E tests, see [e2e/VSCODE_INTEGRATION_TESTS.md](hhttps://github.com/MatterAIOrg/Orbital-Extension/blob/main/e2e/VSCODE_INTEGRATION_TESTS.md).

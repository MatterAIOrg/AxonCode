...
# Using v0 With Orbital

Orbital supports v0, Vercel's AI model provider that offers an OpenAI-compatible API. This allows you to use v0's models with Orbital through the familiar OpenAI API interface.

## Prerequisites

To use v0 with Orbital, you'll need:
...
Setting up v0 in Orbital is straightforward:

1. In Orbital settings (click the <Codicon name="gear" /> icon):
...
<img src="/docs/img/providers/v0-setup.png" alt="v0 configuration in Orbital settings" width="600" />

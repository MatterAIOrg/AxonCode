...
## Why Orbital Uses MCP

Orbital leverages MCP to provide:
...
MCP creates a universal connector between Orbital and external services, with REST APIs often powering those services behind the scenes.

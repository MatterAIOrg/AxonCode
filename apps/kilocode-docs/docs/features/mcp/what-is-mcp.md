...
Orbital implements the Model Context Protocol to:
...
- [Using MCP in Orbital](/orbital/features/mcp) - Get started with MCP in Orbital, including creating simple servers
